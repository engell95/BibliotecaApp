...
const AuthorPage = () => {
    ...
    const [lstAuthor, setLsAuthor] = useState([] as Array<IModelAuthor>);
    const [lstFilter, setLstFilter] = useState([] as Array<IModelAuthor>);
    ...
    return(
        <React.Fragment>
            ...
            <Row justify="center" align="middle">
                <Col flex="auto">
                    <Table scroll={{x:500}} columns={columns} rowKey="id" dataSource={ lstFilter.length > 0 ? lstFilter : lstAuthor} size="small" loading={loading} />              
                </Col>
            </Row>
        </React.Fragment>
    );
